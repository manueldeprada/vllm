...
class Sampler(nn.Module):
    ...
    def forward(
        ...
        if num_logprobs is not None:
            if logprobs_mode == "raw_logprobs" or logprobs_mode == "raw_processed_logprobs":
        ...
        if num_logprobs is None:
            ...
            raw_logprobs_tensors = LogprobsTensors(
        ...
        if sampling_metadata.all_random:
            ...
            if sampling_metadata.all_greedy:
                ...
                if sampling_metadata.max_num_logprobs is not None:
                    ...
                    elif logprobs_mode == "processed_logprobs" or logprobs_mode == "raw_processed_logprobs":
